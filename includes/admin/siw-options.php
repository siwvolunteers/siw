...
add_action( 'admin_menu', function () {
	...
	add_submenu_page('siw_settings', __('Instellingen SIW', 'siw'), __('Agenda', 'siw'), 'manage_options', 'siw_settings');
	add_submenu_page('siw_settings', __('Instellingen SIW', 'siw'), __('Algemeen', 'siw'), 'manage_options', 'admin.php?page=siw_settings&tab=general');
	add_submenu_page('siw_settings', __('Instellingen SIW', 'siw'), __('API keys', 'siw'), 'manage_options', 'admin.php?page=siw_settings&tab=api');
	add_submenu_page('siw_settings', __('Instellingen SIW', 'siw'), __('EVS', 'siw'), 'manage_options', 'admin.php?page=siw_settings&tab=evs');
	add_submenu_page('siw_settings', __('Instellingen SIW', 'siw'), __('Community Day', 'siw'), 'manage_options', 'admin.php?page=siw_settings&tab=community_day');
	add_submenu_page('siw_settings', __('Instellingen SIW', 'siw'), __('Formulieren', 'siw'), 'manage_options', 'admin.php?page=siw_settings&tab=forms');
	add_submenu_page('siw_settings', __('Instellingen SIW', 'siw'), __('Login', 'siw'), 'manage_options', 'admin.php?page=siw_settings&tab=login');
	add_submenu_page('siw_settings', __('Instellingen SIW', 'siw'), __('Ondertekening', 'siw'), 'manage_options', 'admin.php?page=siw_settings&tab=signatures');
	add_submenu_page('siw_settings', __('Instellingen SIW', 'siw'), __('PLATO', 'siw'), 'manage_options', 'admin.php?page=siw_settings&tab=plato');
	add_submenu_page('siw_settings', __('Instellingen SIW', 'siw'), __('Tarieven', 'siw'), 'manage_options', 'admin.php?page=siw_settings&tab=tariffs');
	add_submenu_page('siw_settings', __('Instellingen SIW', 'siw'), __('Vacatures', 'siw'), 'manage_options', 'admin.php?page=siw_settings&tab=jobs');
});
...
function siw_settings_page () {?>
    <div class="wrap">
		...
		<h2 class="nav-tab-wrapper">
			<a href="?page=siw_settings&tab=agenda" class="nav-tab <?php echo 'agenda' == $active_tab ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Agenda', 'siw');?></a>
			<a href="?page=siw_settings&tab=general" class="nav-tab <?php echo 'general' == $active_tab ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Algemeen', 'siw');?></a>
			<a href="?page=siw_settings&tab=api" class="nav-tab <?php echo 'api' == $active_tab ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('API keys', 'siw');?></a>
			<a href="?page=siw_settings&tab=community_day" class="nav-tab <?php echo 'community_day' == $active_tab ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Community Day', 'siw');?></a>
			<a href="?page=siw_settings&tab=evs" class="nav-tab <?php echo 'evs' == $active_tab ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('EVS', 'siw');?></a>
			...
			<a href="?page=siw_settings&tab=login" class="nav-tab <?php echo 'login' == $active_tab ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Login', 'siw');?></a>
			<a href="?page=siw_settings&tab=signatures" class="nav-tab <?php echo 'signatures' == $active_tab ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Ondertekening', 'siw');?></a>
			<a href="?page=siw_settings&tab=plato" class="nav-tab <?php echo 'plato' == $active_tab ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('PLATO', 'siw');?></a>
			<a href="?page=siw_settings&tab=tariffs" class="nav-tab <?php echo 'tariffs' == $active_tab ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Tarieven', 'siw');?></a>
			<a href="?page=siw_settings&tab=jobs" class="nav-tab <?php echo 'jobs' == $active_tab ? 'nav-tab-active' : ''; ?>"><?php esc_html_e('Vacatures', 'siw');?></a>
		</h2>
 ...
 */
add_action( 'update_option_siw_signature_evs', function ( $old_value, $value ) {
	siw_update_vfb_mail_template('evs');
}, 10, 3 );

add_action( 'update_option_siw_signature_op_maat', function ( $old_value, $value ) {
	siw_update_vfb_mail_template('op_maat');
}, 10, 3 );

add_action( 'update_option_siw_signature_community_day', function ( $old_value, $value ) {
